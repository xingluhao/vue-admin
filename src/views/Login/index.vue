<template>
  <div id="login">
    <div class="login-wrap">
      <ul class="ment-tab">
        <li :class="{'current' : item.current}" v-for="item in menuTab" :key="item.id"
      ...
      <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" class="login-form" size="medium">
        ...
        <el-form-item prop="code">
          ...
          <el-row :gutter="11">
            ...
            <el-col :span="9">
              <el-button type="success" class="block" clearable>获取验证码</el-button>
            </el-col>
          </el-row>
        </el-form-item>

        <el-form-item>
          <el-button type="danger" @click="submitForm('ruleForm')" class="login-but block">提交</el-button>
        </el-form-item>
